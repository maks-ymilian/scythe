...
const char jsfx[] = RAW_STRING_LITERAL(
public import "Math.scy"
public import "String.scy"
public import "GFX.scy"
...
const char math[] = RAW_STRING_LITERAL(
...
const char string[] = RAW_STRING_LITERAL(
...
const char gfx[] = RAW_STRING_LITERAL(
